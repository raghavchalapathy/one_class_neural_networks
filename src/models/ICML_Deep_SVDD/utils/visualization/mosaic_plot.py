...
def plot_mosaic(W, title=None, canvas="white", export_pdf=False, show=False):
    """
    Plot filters of a convolutional layer or images in a mosaic. The function is capable of plotting
    grayscale or RGB images.

    :param W: W-parameter of a 2D convolutional layer with shape
        (num_filters, num_input_channels, filter_rows, filter_columns)
        already converted to a numpy-array or a set of
        images with shape (num_images, num_input_channels, image_rows, image_columns)
    """
    print(" [ INFO ] : ","Plot filters of a convolutional layer or images in a mosaic. ")
