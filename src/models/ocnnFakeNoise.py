...
class OCNNFakeNoiseNN(BaseEstimator, ClassifierMixin):  
    ...
    def train_OCNN_Classifier(self,X_trainPos,X_trainNeg,nu,activation,epochs):
        ...
        import time
        print ("X_trainNeg:",X_trainNeg.shape)
        # Layer's sizes
        ...
        XNegative = tf.placeholder("float32", shape=[None, x_size],name="XNegative")
        ...
        cost    = ocnn_obj(theta, X,XNegative,  nu, w_1, w_2, g,r,bias1,bias2)
        ...
        for epoch in range(epochs):
            ...
            with sess.as_default():
                ...
                costvalue = compute_LossValue(train_X,X_trainNeg, nu, w_1, w_2, g, rvalue,bias1,bias2)
